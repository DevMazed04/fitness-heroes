...
const Questions = () => {
   return (
      <div>
         ...
         <div className="accordion border border-0 mx-auto mt-4 mt-sm-5 my-lg-4 px-4 px-lg-5 rounded"
            id="accordionExample">
            <div className="accordion-item border border-0 mb-3">
               ...
               <div id="collapseOne" className="accordion-collapse collapse show rounded-3" aria-labelledby="headingOne"
                  ...
                  <div className="accordion-body text-secondary px-0 pe-3 px-lg-4 pb-3 px-3">
                     <small>
